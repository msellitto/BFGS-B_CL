/*
 *  getopt.c - Portable implementation of getopt() command line args parser, 
 ...
 *              'p' to accomplish this.  Examples: getopt(), optarg, optind,
 *              getopt.c, getopt.h.
...
getopt(int argc, char *argv[], const char *optstring)
{
	...
	const char *OptString;               /* the string in our program */
